...
const Dashboard = ({ style, title, regions, onDateChange }) => {
  ...
  const minY = Math.min(...[
    (
      abonsDataArray || []
    )[currentLineChart === 'aab' ? 0 : currentLineChart === 'nab' ? 1 : currentLineChart === 'otkl' ? 2 : 0]
      ...
      >
        ...
        <div className='tariffs-tooltip-pie-block'>
          ...
          <div className='tariffs-tooltip-pie'>
            <ResponsivePie
              data={[
                { id: 'ААБ', value: currentTariff?.aab }, {
                  id: 'НАБ',
                  value: currentTariff?.nab
                },
              ]}
              height={80}
              width={170}
            ...
            <div className='tariffs-tooltip-stats-inner'>
              ...
              <span>{Number((
                (
                  ...
                  (
                    currentTariff?.nab + currentTariff?.aab
                  ) || 0
                ) * 100
              ).toFixed(1) || 0)}%</span>
    ...
    <div className='dashboard' style={{ ...style }}>
      ...
      <div className='statistics'>
          ...
          <div className='abons-chart'>
            ...
            <ResponsiveLine
              ...
              tooltip={({ point }) => (
                ...
                >
                  <span className='responsive-line-tooltip-pointer'
                    style={{ borderTop: `6px solid ${point['color']}` }}/>
                  <div style={{
        ...
        <div className='paper tariffs'
          onMouseMove={() => setShowCurrentTariff(false)}>
